...
function (_React$PureComponent) {
  ...
  function Rule() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderArea", function (payloadProperty) {
      ...
      return _react.default.createElement("div", null, _react.default.createElement(_Checkbox.default, {
        tick: 1
      }), _react.default.createElement(_Area.default, {
        defaultValue: '',
        id: id,
  ...
  _createClass(Rule, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
      ...
      }, isEditingBefore && this.renderArea(_COMMON.BEFORE), !isTop && _react.default.createElement("div", {
        ...
        tick: 1,
        onTick: onTick
      }), isEditingSelector ? _react.default.createElement(_Area.default, {
      ...
      }, cleanSelector), !isValid && _react.default.createElement(_Alert.default, null), !hasSemicolon && _react.default.createElement("span", {
        ...
        return _react.default.createElement(Component, _extends({}, item, {
          key: item.id,
      ...
      })), !isTop && !hasSemicolon && _react.default.createElement("div", {
